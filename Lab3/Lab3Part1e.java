...
public class Lab3Part1e {
    ...
    public static void main(String[] args) 
    {
        ...
        while(Continue == 'Y')
        {
            ...
            System.out.println("B) Puzzle #2\n");
            System.out.println("C) Puzzle #3\n");
            ...
            else if(choice != 'A' || choice != 'B' || choice != 'C' || choice != 'Q')
            {
                System.out.println("\nInvalid Choice!\nPlease choose one of the following! ( A , B , C , Q )");
            }
        }
    }
    ...
    {
        int dde, deed;
        System.out.println("\nLet's see which #'s for e and d, from 0-9, will make the following equation true: (DD)^E = DEED");
        for (int e = 0; e <= 9;e++)
        { 
            for (int d = 0; d <= 9; d++)
            {
    ...
    public static void showSize()
    {
        ...
        System.out.println("\nEnter your shoe size and round up if you wear a half-size.");
    ...
    public static void lastFourDigits()
    {
        ...
        System.out.println("\nLets see which four digit # for n, from 0-9999, will keep the last four digits equal to n when n^2\n");
