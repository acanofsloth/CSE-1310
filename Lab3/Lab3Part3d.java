...
public class Lab3Part3d {
    ...
    public static void main(String[] args) {
        ...
        {
            for(int c = 0;c < (nl-RrobotName[loc].length());c++)
            {
                System.out.print(" ");
            }
            System.out.print(RrobotName[loc]);
            for(int c = 0; c < 2;c++)
            {
                System.out.print(" ");
            }
            System.out.print(RrobotYear[loc]);
            for(int c = 0;c < 3;c++)
            {
                System.out.print(" ");
            }
            switch(RrobotCost[loc].length())
            {
                case 4:
                    System.out.print(RrobotCost[loc]);
                    for(int c = 0; c < 2;c++)
                    {
                        System.out.print(" ");
                    }
                    System.out.print(RrobotSource[loc]);
                    break;
                case 3:
                    System.out.print(RrobotCost[loc]);
                    for(int c = 0; c < 3;c++)
            ...
            for(int c = 0;c < (catl-RrobotKind[loc].length()+5);c++)
            {
                System.out.print(" ");
            }
            System.out.print(RrobotKind[loc]);
            System.out.println(" " + RrobotSourceTitle[loc]);
        }
    }
