 ...
 * @author marti
 */
public class Lab4Part1b 
{
    public static void main(String[] args) throws FileNotFoundException
    {
        String newFileName = "robotsInfoHW.txt";
        String newOutFile = "Lab4Part1b.out";
        String robotName; 
        int robotYear; 
        String robotKind; 
        char robotSource; 
        ...
        for(int loc = 0; loc < count;loc++)
        {
            ...
            if(2 == RobotString2D[loc][iCost].length())
            {
                ...
                {
                    RobotInt2D[loc][iCostValue] = (int)Double.parseDouble(robotCost.substring(0,1));
                    RobotInt2D[loc][iCostValue] = RobotInt2D[loc][iCostValue]*1000;
                }
                if(RobotString2D[loc][iCost].indexOf("M") > 0)
                {
                    RobotInt2D[loc][iCostValue] = (int)Double.parseDouble(robotCost.substring(0,1));
                    RobotInt2D[loc][iCostValue] = RobotInt2D[loc][iCostValue]*1000000;
                }
                if(RobotString2D[loc][iCost].indexOf("B") > 0)
                {
                    RobotInt2D[loc][iCostValue] = (int)Double.parseDouble(robotCost.substring(0,1));
                    RobotInt2D[loc][iCostValue] = RobotInt2D[loc][iCostValue]*1000000000;
                }
            }
            if(3 == RobotString2D[loc][iCost].length())
            {
                if(RobotString2D[loc][iCost].indexOf("K") > 0)
                {
                    RobotInt2D[loc][iCostValue] = (int)Double.parseDouble(robotCost.substring(0,2));
                    RobotInt2D[loc][iCostValue] = RobotInt2D[loc][iCostValue]*1000;
                }
                if(RobotString2D[loc][iCost].indexOf("M") > 0)
                {
            ...
            if(4 == RobotString2D[loc][iCost].length())
            {
                ...
                {
                    RobotInt2D[loc][iCostValue] = (int)Double.parseDouble(robotCost.substring(0,3));
                    RobotInt2D[loc][iCostValue] = RobotInt2D[loc][iCostValue]*1000;
                }
            ...
            if(5 == RobotString2D[loc][iCost].length())
            {
                if(RobotString2D[loc][iCost].indexOf("K") > 1)
                {
                    RobotInt2D[loc][iCostValue] = (int)Double.parseDouble(robotCost.substring(0,4));
                    RobotInt2D[loc][iCostValue] = RobotInt2D[loc][iCostValue]*1000;
                }
                if(RobotString2D[loc][iCost].indexOf("M") > 1)
                {
    ...
    public static void RoboTable(String RobotString2D[][], int RobotInt2D[][], double RobotDouble2D[][], char RobotChar2D[][] , int count, String newOutFile) throws FileNotFoundException
    {
        ...
        for(int loc = 0; loc < count;loc++) //start for data inputs
        {
            ...
            System.out.println(" " +RobotString2D[loc][iTitle]);
            OutFile.println(" " +RobotString2D[loc][iTitle]);
        }
